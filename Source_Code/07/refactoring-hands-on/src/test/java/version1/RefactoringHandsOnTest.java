...
public class RefactoringHandsOnTest {
    ...
    @Test
    public void locarVariosFilmesComoNesteExemploDeveGerarUmaSaidaComNomeClienteFilmesLocadosTotalDevidoEPontosAdquiridos() {
        ...
        assertEquals(saidaEsperadaSemEspacos, rodrigo.conta().replaceAll("\\s", ""));
     }
