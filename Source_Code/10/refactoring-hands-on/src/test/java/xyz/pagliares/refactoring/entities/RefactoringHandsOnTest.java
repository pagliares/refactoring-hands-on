...
public class RefactoringHandsOnTest {
    ...
    public void locarVariosFilmesComoNesteExemploDeveGerarUmaSaidaEmHTMLComNomeClienteFilmesLocadosTotalDevidoEPontosAdquiridos() {
        ...
        Movie encontros = new Movie("Encontros e Desencontros", 0);
        ...
        Movie meia = new Movie("Meia-Noite em Paris           ", 1);
        ...
        Movie parisTexas = new Movie("Paris, Texas             ", 0);
        ...
        Movie indomita = new Movie("Bravura Indômita           ", 1);
